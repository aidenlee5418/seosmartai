...
import { downloadFile, jsonToCsv } from "../utils/report";
  ...
  const loadAnalysisHistory = async () => {
    try {
      ...
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-fb0be124/analysis-history`,
        {
          headers: {
        ...
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600">
              Your 7-day free trial has started. Let&apos;s run your first
              analysis and see what we can optimize.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <Badge
                  variant="secondary"
                  className="ml-3 bg-blue-50 text-blue-700 border-blue-200"
                >
                  Pro Trial
                </Badge>
              </div>
          ...
          <TabsContent value="dashboard" className="space-y-8">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-blue-100 mb-6 text-lg">
                      Ready to dominate search results? Let&apos;s make your
                      competitors nervous.
                    </p>
                    <Button
                      variant="secondary"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <Card className="border border-gray-200">
                <CardHeader>
                  ...
                  <CardDescription>
                    Automate your SEO workflow with intelligent analysis
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="border border-gray-200">
                <CardHeader>
                  ...
                  <CardDescription>
                    Advanced tools for technical SEO mastery
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <ToolCard
            ...
            <Card className="border border-gray-200">
              <CardHeader>
                ...
                <CardDescription>
                  Your latest SEO wins and improvements
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
...
function AnalysisHistoryItem({ analysis }: { analysis: any }) {
    ...
    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
      <div className="flex items-center space-x-3">
        <div className="p-2 bg-blue-50 rounded-lg">
          <div className="text-blue-600">{getTypeIcon(analysis.type)}</div>
        </div>
        <div>
